...
export class RateLimitService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:getambassador.io/v3alpha1:RateLimitService';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.getambassador.v3alpha1.RateLimitServiceSpec | undefined>;
...
export interface RateLimitServiceArgs {
     ...
     * RateLimitServiceSpec defines the desired state of RateLimitService
     */
    readonly spec?: pulumi.Input<inputs.getambassador.v3alpha1.RateLimitServiceSpecArgs>;
}
