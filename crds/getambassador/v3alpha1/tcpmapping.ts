...
export class TCPMapping extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:getambassador.io/v3alpha1:TCPMapping';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.getambassador.v3alpha1.TCPMappingSpec | undefined>;
...
export interface TCPMappingArgs {
     ...
     * TCPMappingSpec defines the desired state of TCPMapping
     */
    readonly spec?: pulumi.Input<inputs.getambassador.v3alpha1.TCPMappingSpecArgs>;
}
