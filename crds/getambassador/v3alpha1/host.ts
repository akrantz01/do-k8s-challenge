...
export class Host extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:getambassador.io/v3alpha1:Host';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.getambassador.v3alpha1.HostSpec | undefined>;
    /**
     * HostStatus defines the observed state of Host
     */
    public readonly status!: pulumi.Output<outputs.getambassador.v3alpha1.HostStatus | undefined>;
...
export interface HostArgs {
     ...
     * HostSpec defines the desired state of Host
     */
    readonly spec?: pulumi.Input<inputs.getambassador.v3alpha1.HostSpecArgs>;
    /**
     * HostStatus defines the observed state of Host
     */
    readonly status?: pulumi.Input<inputs.getambassador.v3alpha1.HostStatusArgs>;
}
