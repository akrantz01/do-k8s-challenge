...
export class KubernetesServiceResolver extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:getambassador.io/v3alpha1:KubernetesServiceResolver';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.getambassador.v3alpha1.KubernetesServiceResolverSpec | undefined>;
    ...
    constructor(name: string, args?: KubernetesServiceResolverArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["kind"] = "KubernetesServiceResolver";
        ...
        super(KubernetesServiceResolver.__pulumiType, name, inputs, opts);
    }
}
...
export interface KubernetesServiceResolverArgs {
    ...
    readonly kind?: pulumi.Input<"KubernetesServiceResolver">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    /**
     * KubernetesServiceResolver tells Ambassador to use Kubernetes Service resources to resolve services. It actually has no spec other than the AmbassadorID.
     */
    readonly spec?: pulumi.Input<inputs.getambassador.v3alpha1.KubernetesServiceResolverSpecArgs>;
}
