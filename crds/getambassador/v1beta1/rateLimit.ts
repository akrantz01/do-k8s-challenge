...
export class RateLimit extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: RateLimitArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            inputs["apiVersion"] = "getambassador.io/v1beta1";
            inputs["kind"] = "RateLimit";
...
export interface RateLimitArgs {
    readonly apiVersion?: pulumi.Input<"getambassador.io/v1beta1">;
    readonly kind?: pulumi.Input<"RateLimit">;
