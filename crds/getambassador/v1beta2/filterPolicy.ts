...
export class FilterPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: FilterPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            inputs["apiVersion"] = "getambassador.io/v1beta2";
            inputs["kind"] = "FilterPolicy";
        ...
        super(FilterPolicy.__pulumiType, name, inputs, opts);
    }
}
...
export interface FilterPolicyArgs {
    readonly apiVersion?: pulumi.Input<"getambassador.io/v1beta2">;
    readonly kind?: pulumi.Input<"FilterPolicy">;
